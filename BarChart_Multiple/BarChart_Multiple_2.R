...
par( omi = c(0,0.75,1.25,0.75), mai = c(1.6,3.75,0.5,0), lheight = 1.15, family = 'Lato Light', las = 1)
...
x <- barplot(myData1,horiz = TRUE,names.arg = myNames,cex.names = 1.1,border = NA, xlim = c(0,100),col = myColors, axes = FALSE)
...
mtext('Redesigned by: Phan Tien Dung\nUniversity of Tuebingen, Germany', side = 1, line = 4.5, adj = 1, cex = 1.05, font = 3, family = 'Lato Black')
